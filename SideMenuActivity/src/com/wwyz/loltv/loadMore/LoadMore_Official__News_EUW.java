...
public class LoadMore_Official__News_EUW extends LoadMore_Base {
	...
	private int pageNum;
	private final String baseUri = "http://beta.euw.leagueoflegends.com";
	...
	private class getMatchInfo extends LoadMoreTask {
		...
		private void pullNews(String responseString) {
			...
			if (pages != null && pages.size() == 0) {
				...
				isMoreVideos = true;
				pageNum++;
				API.add("http://beta.euw.leagueoflegends.com/en/news?page="
						+ pageNum);
