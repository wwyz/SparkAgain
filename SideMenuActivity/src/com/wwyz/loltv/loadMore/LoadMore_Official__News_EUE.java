...
public class LoadMore_Official__News_EUE extends LoadMore_Base {
	...
	private int pageNum;
	private final String baseUri = "http://beta.eune.leagueoflegends.com";
	...
	public void Initializing() {
		...
		// Give API URLs
		API.add("http://beta.eune.leagueoflegends.com/en/news/");
...
//				System.out.println("Number of News: " + links.size());
			...
			if (pages != null && pages.size() == 0) {
				...
				isMoreVideos = true;
				pageNum++;
				API.add("http://beta.eune.leagueoflegends.com/en/news?page="
						+ pageNum);
